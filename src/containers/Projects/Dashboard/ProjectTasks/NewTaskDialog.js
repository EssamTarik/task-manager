	...
	render(){
		return (
			...
			<form onSubmit={this.props.handleSubmit}>
				<Field autoComplete="off" component={TextField} fullWidth={true} floatingLabelText="Name" name="name" />
				<Field autoComplete="off" component={TextField} fullWidth={true} floatingLabelText="Time(hr)" name="time" />
